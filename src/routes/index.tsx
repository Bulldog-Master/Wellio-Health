...
export const AppRoutes = () => (
  <Routes>
    ...
    <Route path="/coach" element={<RouteErrorBoundary><ProtectedRoute><Layout><CoachDashboard /></Layout></ProtectedRoute></RouteErrorBoundary>} />
    <Route path="/clinician" element={<RouteErrorBoundary><ProtectedRoute><Layout><ClinicianDashboard /></Layout></ProtectedRoute></RouteErrorBoundary>} />
