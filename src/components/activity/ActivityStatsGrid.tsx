...
import { Calendar, Flame, Activity as ActivityIcon, TrendingUp } from "lucide-react";
...
export const ActivityStatsGrid = ({ weeklyStats, preferredUnit }: ActivityStatsGridProps) => {
