...
| Asset | Location |
|-------|----------|
| README Banner | `docs/assets/banners/readme-hero-banner.svg` |
| Care Team Access Model | `docs/assets/diagrams/care-team-access-model.svg` |
| Coach Pro Badge | `docs/assets/badges/coach-pro.svg` |
| Coach Team Badge | `docs/assets/badges/coach-team.svg` |
| Clinician Individual Badge | `docs/assets/badges/clinician-individual.svg` |
| Clinician Group Badge | `docs/assets/badges/clinician-group.svg` |
